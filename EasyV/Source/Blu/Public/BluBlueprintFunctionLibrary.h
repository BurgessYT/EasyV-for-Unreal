...
class BLU_API UBluBlueprintFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure, meta = (HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject", DisplayName = "Create EasyV Core", CompactNodeTitle = "EasyV", Keywords = "new create EasyV Core"), Category = Blu)
	static UBluEye* NewEasyVCore(UObject* WorldContextObject);
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Run Tick", Keywords = "blui blu eye blui tick"), Category = Blu)
